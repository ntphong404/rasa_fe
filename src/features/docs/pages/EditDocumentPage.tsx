  ...
  return (
    <div className="container mx-auto py-6 max-w-3xl p-3">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-3xl font-bold">{t("Edit Document")}</h1>
      </div>

      <div className="space-y-6">
        {/* Current File Info */}
        <div className="space-y-2">
          <Label>{t("Current File")}</Label>
            ...
            {!file ? (
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {t("Leave empty to keep current file")}
                </p>
              </div>
            ) : (
        ...
        <div className="flex gap-2 justify-end pt-4">
          ...
          >
            {isSubmitting ? t("Updating...") : t("Update Document")}
          </Button>
        </div>
      </div>
    </div>
