  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col p-0">
        <DialogHeader className="px-6 pt-6 pb-4 border-b bg-gradient-to-r from-violet-50 to-fuchsia-50 dark:from-slate-900 dark:to-slate-800 dark:border-white/10">
        ...
        {story && (
          <div className="flex-1 overflow-y-auto px-3 py-3 pt-0">
            <div className="space-y-2">
              ...
              <div className="bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-slate-900 dark:to-slate-900 border border-violet-200 dark:border-violet-900/50 rounded-lg p-3">
                <div className="space-y-2">
                  <div>
                    <h3 className="text-xs font-semibold text-violet-600 uppercase tracking-wide mb-1">
                      {t("Story Name")}
                    </h3>
                    <p className="text-lg font-bold text-violet-900 dark:text-violet-200">{story.data?.name || "N/A"}</p>
                  </div>
                  {story.data?.description && (
                    <div>
                      ...
                      <p className="text-sm text-foreground">{story.data.description}</p>
                    </div>
                  )}
                </div>
              </div>
